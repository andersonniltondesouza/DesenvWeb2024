...
<body>
    ...
    <?php
         if (isset($_POST['lado'])){
            ...
            $m2 = $lado*$comprimento;
            if ($m2 > 10) {
                echo ("<h1> A área do quadrado de lado $lado metros e de $comprimento metros é $m2 metros quadrados </h1>");
            }
            else {
                echo ("<h3> A área do quadrado de lado $lado metros e de $comprimento metros é $m2 metros quadrados </h3>");
            }
        }
    ?>
</body>
